            ...
            <div class="row">
                <div class="col-md-5">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control kredikarti" id="kartno" name="kartno"
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                Ay
                                <select name="son_kullanim_tarihi_ay" id="son_kullanim_tarihi_ay" class="form-control"
                                    required>
                                    <option>1</option>
                                </select>
                            </div>
                            <div class="col-md-6">
                                Yıl
                                <select name="son_kullanim_tarihi_yil" id="son_kullanim_tarihi_yil" class="form-control"
                                    required>
                                    <option>2017</option>
                                </select>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="adsoyad" id="adsoyad" value="{{$kullanicidetay->kullanici->adsoyad}}" class="form-control" placeholder="" />
                            </div>
                        </div>
                        <div class="col-md-8">
                            <div class="form-group">
                                <label for="adres">Adres</label>
                                <input type="text" value="{{$kullanicidetay->adres}}" name="adres" id="adres" class="form-control" placeholder="" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="telefon">Ev telefonu</label>
                                <input type="text" name="telefon" id="telefon"  value="{{$kullanicidetay->telefon}}" class="form-control telefon" placeholder="" />
                            </div>
                        </div>
                        <div class="col-md-8">
                            <div class="form-group">
                                <label for="ceptelefon">Cep Telefonu</label>
                                <input type="text" name="ceptelefon" id="ceptelefon" value="{{$kullanicidetay->ceptelefon}}" class="form-control telefon" placeholder="" />
                            </div>
                        </div>
                    </div>
                </div>
